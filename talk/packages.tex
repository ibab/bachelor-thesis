\documentclass[hyperref={unicode=true},xcolor={table},english]{beamer}
...
\usepackage{babel}
\usepackage[backend=biber,sortlocale=en_US.UTF-8,style=authoryear-comp]{biblatex}
...
\usepackage[strict,autostyle,babel]{csquotes}
\usepackage{hyphenat}
\usepackage{textcmds}
\usepackage{xspace}
\usepackage{eurosym}
