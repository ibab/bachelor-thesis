\documentclass[twoside,BCOR=12mm,parskip=half]{scrartcl}
...
\newcommand \thetitle
{
        Flavour-Tagging-Kalibration~des~SS\Pgp-Taggers~mittels~$\PBzero \to \PJpsi \PKst$-Zerfällen~am~LHCb-Experiment
}
